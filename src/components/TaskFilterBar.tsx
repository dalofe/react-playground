...
export function TaskFilterBar({ tasks, sort, onSortChange, filter, onFilterChange }: TaskFilterBarProps) {
  ...
  return (
    <div className="flex gap-4 items-center p-3 bg-gray-100 rounded-lg">
      <div>
        ...
        <select value={filter} onChange={(e) => onFilterChange(e.target.value as FilterOptions)}>
